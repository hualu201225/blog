...
<html>
    <head>
    <base href="base_url()">
        <title>WYSIWYG Editors | Bootstrap 3.x Admin Theme</title>
        ...
        <!-- Vendors -->
        <link rel="stylesheet" media="screen" href="public/vendors/bootstrap-wysihtml5-rails-b3/vendor/assets/stylesheets/bootstrap-wysihtml5/core-b3.css">
    ...
    <body class="bootstrap-admin-with-small-navbar">
        ...
        <script type="text/javascript" src="public/js/bootstrap-admin-theme-change-size.js"></script>

        <script type="text/javascript" src="public/vendors/ckeditor/ckeditor.js"></script>
        <script type="text/javascript" src="public/vendors/ckeditor/adapters/jquery.js"></script>

        <script type="text/javascript" src="public/vendors/tinymce/js/tinymce/tinymce.min.js"></script>

        <script type="text/javascript" src="public/vendors/bootstrap-wysihtml5-rails-b3/vendor/assets/javascripts/bootstrap-wysihtml5/wysihtml5.js"></script>
        <script type="text/javascript" src="public/vendors/bootstrap-wysihtml5-rails-b3/vendor/assets/javascripts/bootstrap-wysihtml5/core-b3.js"></script>
        ...
        <script type="text/javascript">
            ...
            $('#bootstrap-editor').wysihtml5({
                stylesheets: [
                    'public/vendors/bootstrap-wysihtml5-rails-b3/vendor/assets/stylesheets/bootstrap-wysihtml5/wysiwyg-color.css'
                ]
            });
        </script>
    </body>
